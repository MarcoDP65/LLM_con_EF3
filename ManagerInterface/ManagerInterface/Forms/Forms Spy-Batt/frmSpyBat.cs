        ...
        */
        ...
        public void GraficoTemporaleSett(string TitoloGrafico, DatiEstrazione DatiGraph, ref OxyPlot.PlotModel Grafico)
        {
            try
            {
                ...
                AsseCarica.AxislineThickness = 2;
                AsseCarica.AxislineStyle = OxyPlot.LineStyle.Solid;
                AsseCarica.AxislineColor = OxyPlot.OxyColors.Black;
                ...
                //AsseElAvail.IsAxisVisible = false;
                ...
                AsseLabelGiorni.Labels.Add("Lun");
                AsseLabelGiorni.Labels.Add("Mar");
                AsseLabelGiorni.Labels.Add("Mer");
                AsseLabelGiorni.Labels.Add("Gio");
                AsseLabelGiorni.Labels.Add("Ven");
                AsseLabelGiorni.Labels.Add("Sab");
                AsseLabelGiorni.Labels.Add("Dom");
                ...
                serCarica.Title = "Fase di Carica";
                ...
                serEqual.Title = "Fase di Equalizzazione";
                ...
                serScarica.Title = "Fase di Scarica";
                serScarica.FillColor = OxyPlot.OxyColors.LightYellow;
                Grafico.Series.Add(serScarica);

                //serCicli.Title = DatiGraph.Titolo;

                //serCicli.DataFieldX = "Durata";
                //serCicli.DataFieldY = "Numero";
                //serCicli.Color = OxyPlot.OxyColors.Blue;
                ...
                foreach (_StatCicloSBPeriodo ciclo in DatiGraph.DatiPeriodo)
                {
                    ...
                    //_punto.X = _posMin;
                    //_punto.Y = (double)(ciclo.TempMin + ciclo.TempMax) / 2;
