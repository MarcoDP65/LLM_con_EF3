        ...
        public void inizializzaUtente()
        {
            ...
            if (!TabellaCompilata)
            {
                _utente[] usr = {
                                  ...
                                  new _utente { Id = 40, Username = "USER", Password = Utility.StringCipher.PasswordEncrypt("UT16MR28"), NomeUtente = "Livello User", Livello = 3, Lingua = 0, Attivo = 1 ,NoLockClearSB = 0}
                                };
