...
namespace MoriData
{
    public class _scStatoFirmware
    {
        ...
        public ushort FwControlCode { get; set; }
        public string RevBootloader { get; set; }
        public string RevFirmware { get; set; }
        public ushort CRCFirmware { get; set; }
        public UInt32 LenPacchetti { get; set; }
        public UInt32 LenApp { get; set; }
        public byte NumAree { get; set; }
    ...
    public class scStatoFirmware
    {
        public string nullID { get { return "0000000000000000"; } }
        public _scStatoFirmware _llSFW = new _scStatoFirmware();
        public bool valido;
        ...
        public scStatoFirmware()
        {
            _llSFW = new _scStatoFirmware();
            valido = false;
            _datiSalvati = true;
        ...
        public scStatoFirmware(_db connessione)
        {
            valido = false;
            _llSFW = new _scStatoFirmware();
        ...
        private _scStatoFirmware _caricaDati(int _id)
        {
            return (from s in _database.Table<_scStatoFirmware>()
