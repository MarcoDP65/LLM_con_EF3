...
namespace ChargerLogic
{
    public partial class MessaggioSpyBatt : SerialMessage
    {
        ...
        private static ILog Log = LogManager.GetLogger("Messaggio Spybatt");
        ...
        new public EsitoRisposta analizzaMessaggio(byte[] _messaggio, int fwLevel, bool skipHead = false, bool CreateMsgObject = false)
        {
            ...
            try
            {
                ...
                switch (_comando)
                {
                    ...
                    case (byte)TipoComando.CMD_ESP32_PROXY: // messaggio proxy esp32
                        {
                            _endPos = _messaggio.Length;
                            _startPos = _endPos - 6;
        ...
        public ushort ComponiMessaggioLeggiProgrammazioniV1()
        {
            ushort _esito = 0;
            ushort _dispositivo;
            byte _comando;
        ...
        public ushort ComponiMessaggioTestEsp32(byte SottoComando)
        {
            ushort _esito = 0;
            ushort _dispositivo;
            byte _comando;
            ...
            try
            {
                ...
                _comando = (byte)(TipoComando.CMD_ESP32_PROXY);
                splitUshort(codificaByte(_comando), ref lsb, ref msb);
                _comandoBase[(20)] = msb;
                _comandoBase[(21)] = lsb;
        ...
        public ushort ComponiMessaggioDirettoEsp32(byte SottoComando)
        {
            ushort _esito = 0;
            ushort _dispositivo;
            byte _comando;
        ...
        public ushort ComponiMessaggioOpenEsp32(byte[] Parametri)
        {
            ushort _esito = 0;
            ushort _dispositivo;
            byte _comando;
